...
public class FutSalTeam_MemberFragment_master extends Fragment implements View.OnClickListener{
    ...
    public static FutSalTeam_MemberFragment_master newInstance() {
        return new FutSalTeam_MemberFragment_master();
    }


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstaceState) {
        View view = inflater.inflate(R.layout.fragment_futsal_team_member_master, null); // Fragment로 불러올 xml파일을 view로 가져옵니다.

        context = container.getContext();
        memberAdapter_master = new FutsalTeam_MemberAdapter_master();
        member = (ListView) view.findViewById(R.id.futsal_team_member_master);
        member.setAdapter(memberAdapter_master);
    ...
    public class Get extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (memberSize != 0) {
                ...
                memberAdapter_master.notifyDataSetChanged();
            } else {
